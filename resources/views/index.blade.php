...
{{-- Halaman Dasboard --}}
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="wrapper d-sm-flex align-items-center gap-2">
                <button type="button" href="#"
                    class="btn btn-primary shadow-sm text-nowrap d-flex align-items-center mx-2" data-toggle="modal"
                    data-target="#exampleModal">
                    <i class="fas fa-download fa-sm text-white-50 px-2"></i>
                    <p class="m-0">Unduh Laporan</p>
                </button>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            Data laporan akan segera di unduh.
                        </p>
                        <p>
                            Data yang diunduh: 12-05-2025 - 31-05-2025
                        </p>
                    </div>
